...
const Pairing: React.FC<PairingProps> = ({
  ...
  return (
    <div className="desc animate__animated animate__slideInUp animate__faster">
      <Layout step={step} className={`h-max max-w-[720px]`} disabled={loading}>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center h-[50vh]">
            ...
            <div
              className="text-center text-white-primary h2-bold"
        ...
        {!loading && (
          <>
              ...
              <div className="flex flex-col items-center justify-center full-w mt-2">
                ...
                >
                  ...
                  <div className="flex text-white-primary mt-4">
                    ...
                    <span className="ml-1 b2-regular text-[#F6F7F9]">
                      {seconds} secs
                    </span>
                  </div>
                </div>
            ...
            >
              <div>
                Follow these steps to pair your mobile device with Snap:
              </div>
              <div className="flex items-center">
                ...
                <div className="flex items-center flex-wrap flex-1">
                  ...
                  />
                  <div className="mr-1 text-white-primary b2-bold">
                    Silent Shard
                  </div>{" "}
                  app from
                  <a
