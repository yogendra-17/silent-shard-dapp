  ...
  return (
    <div>
      <div className={`flex flex-col justify-center items-center`}>
        <Layout className={`h-max ${isMobileWidthSize ? "w-[90vw]" : ""}`}>
          <div className="flex items-center justify-between mt-4">
            <div className="h2-bold text-white-primary">
          ...
          <div className="b2-regular p-2 flex items-center rounded-lg border bg-[rgba(96,154,250,0.1)] border-[#1e55af] text-white-primary my-6">
            <svg
              className="mr-1"
              xmlns="http://www.w3.org/2000/svg"
              width="20"
            ...
            By connecting, you will create a new Snaps account in your existing
            MetaMask extension as shown in the image.
          </div>
        ...
        <div
          className={`mt-6 text-[#B6BAC3] text-center label-regular ${
            isMobileWidthSize ? "w-[90vw]" : ""
          }`}
        >
